...
STATE_DIR="${XDG_STATE_HOME:-$HOME/.local/state}/qs-astra"
...
QS_BIND_BEGIN="# >>> quickshell-astra managed media bindings >>>"
QS_BIND_END="# <<< quickshell-astra managed media bindings <<<"
QS_MENU_BEGIN="# >>> quickshell-astra managed menu bindings >>>"
QS_MENU_END="# <<< quickshell-astra managed menu bindings <<<"
QS_NOTIF_BEGIN="# >>> quickshell-astra managed notification bindings >>>"
QS_NOTIF_END="# <<< quickshell-astra managed notification bindings <<<"

...
workspace="$repo/versions/default/modules/WorkspaceWidget.qml"
...
require 'readonly property bool dense: workspaceList.length > 4' "$workspace"
require 'spacing: wsWidget.dense \? 2 : 5' "$workspace"
require 'wsWidget.dense \? 26 : 32' "$workspace"
